...
=======
  return "<div class=\"loading\"><progress value=\"45\" max=\"100\">\n</progress></br>Loading...</div>";
  });
...
function program23(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\" width=\"300px\"/>\n	</a></br></br>\n	<a class=\"tiny alert button expand round\" href=\"#video/";
  if (stack1 = helpers.id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.id); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "/info\"><span class=\"alert round label\"><b>[ Video Info ]</b></span></a>&nbsp;&nbsp;&nbsp;\n		    <a href=\"#video/";
  if (stack1 = helpers.id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.id); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
<<<<<<< Updated upstream
...
=======
    + "/layers\"><span class=\"alert round label\"><b>[ Transcript ]</b></span></a>\n			<hr>\n		</div>\n</div>\n\n</div>";
>>>>>>> Stashed changes
  return buffer;
  });
