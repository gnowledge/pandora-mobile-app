...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n	In: ";
  if (stack1 = helpers.inPoint) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.inPoint); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + " , Out: ";
  if (stack1 = helpers.outPoint) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.outPoint); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "\n";
  return buffer;
  }
  ...
  buffer += escapeExpression(stack1)
    + "\" controls></video>\n</br>\n";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.inPoint), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
